...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'django', '18.237.137.70', 'cloudworks.dimagi.com', 'www.cloudworks.dimagi.com']
...
LOGGING = {
    ...
    'handlers': {
        ...
        'error-logfile': {
            'level': 'ERROR',
            'class': 'logging.FileHandler',
            'filename': BASE_DIR / 'error-logfile.log',
            'formatter': 'verbose'
        },
        'console': {
            'level': 'INFO',
    ...
    'loggers': {
        'django': {
            'handlers': ['logfile', 'error-logfile', 'console'],
            'level': 'INFO',
            'propagate': True,
        }
    },

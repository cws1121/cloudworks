...
@Component({
  selector: 'ngx-stats-chart-panel-header',
  styleUrls: ['./stats-chart-panel-header.component.scss'],
  templateUrl: './stats-chart-panel-header.component.html',
})
export class StatsChartPanelHeaderComponent implements OnDestroy {

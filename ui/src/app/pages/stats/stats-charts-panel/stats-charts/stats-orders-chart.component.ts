...
@Component({
  selector: 'ngx-stats-orders-chart',
  styleUrls: ['./stats-charts-common.component.scss'],
  template: `
    <div echarts
         [options]="option"
         [merge]="option"
...
export class StatsOrdersChartComponent implements AfterViewInit, OnDestroy, OnChanges {

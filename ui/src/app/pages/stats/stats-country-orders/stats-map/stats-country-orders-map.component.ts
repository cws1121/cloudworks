...
@Component({
  selector: 'ngx-stats-country-orders-map',
  styleUrls: ['./stats-country-orders-map.component.scss'],
  template: `
    <div leaflet [leafletOptions]="options" [leafletLayers]="layers" (leafletMapReady)="mapReady($event)"></div>
  `,
})
export class StatsCountryOrdersMapComponent implements OnDestroy {

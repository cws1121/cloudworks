...
@Component({
  selector: 'ngx-stats-country-orders-chart',
  styleUrls: ['./stats-country-orders-chart.component.scss'],
  template: `
    <div class="header">
...
export class StatsCountryOrdersChartComponent implements AfterViewInit, OnDestroy, OnChanges {

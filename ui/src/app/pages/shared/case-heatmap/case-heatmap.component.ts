...
@Component({
  selector: 'ngx-case-heatmap',
  templateUrl: './case-heatmap.component.html',
  styleUrls: ['./case-heatmap.component.scss']
})
export class CaseHeatmapComponent implements OnDestroy, OnInit {
